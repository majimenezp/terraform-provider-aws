...
func expandMediaPresetSettings(list []interface{}) *mediaconvert.PresetSettings {
	...
	if v, ok := settings["caption_description"]; ok {
		presetSettings.CaptionDescriptions = expandMediaConvertCaptionDescriptionPreset(v.([]interface{}))
	}
...
func expandMediaConvertCaptionDescriptionPreset(list []interface{}) []*mediaconvert.CaptionDescriptionPreset {
